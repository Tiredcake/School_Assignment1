...
class DiceThrower:
    ...
    def player_screen(self):
        ...
        Quit.configure(font=('System', 50),borderwidth=0, background='black',foreground='white', activeforeground='white', activebackground='black')
        Quit.place(relx=0.40, rely=0.8)
    ...
    def login(self):
        ...
        player1_name.pack(ipadx=50,ipady=20, pady = 50)

        player1_name.insert(0, 'Username')
        player1.bind('<FocusIn>', self.placeholder)
        player1.bind('<FocusOut>', self.leave)

        player1_pass = tk.Entry(Framer, font=("Times New Roman", 20))
        player1_pass.pack(ipadx=50,ipady=20, pady=50)
        player1_pass.insert(0, 'Password')


        #Player 2 login
        player2 = tk.Label(Framer, text='Player 2', font=('System', 20), bg='black', fg='white')
        player2.pack()
        player2_name = tk.Entry(Framer, font=("Times New Roman", 20))
        player2_name.pack(ipadx=50, ipady=20, pady=50)
        player2_name.insert(0, 'Username')


        player2_pass = tk.Entry(Framer, font=("Times New Roman", 20))
        player2_pass.pack(ipadx=50, ipady=20)
        player2_pass.insert(0, 'Password')
